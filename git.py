...
#     lines = f.readlines()
#     "KRW-TFUEL" = lines[0].strip()
#     "KRW-XRP" = lines[1].strip()
#     "KRW-CHZ" = lines[2].strip()
#     "KRW-ETC" = lines[3].strip()
#     "KRW-AERGO" = lines[4].strip()
#     "KRW-AHT" = lines[5].strip()
#     "KRW-ADA" = lines[6].strip()
#     "KRW-WAVES" = lines[7].strip()
#     "KRW-THETA" = lines[8].strip()
#     "KRW-EOS" = lines[9].strip()
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_1 = upbit.get_balance(ticker="KRW-TFUEL")
        if krw > 5000 and get1_1 < 0.00001:
            data_1 = pyupbit.get_ohlcv(ticker="KRW-TFUEL", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_1 * 2.0) < curVolume_1:
                macd1_1 = get_macd("KRW-TFUEL", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_1 = get_macd("KRW-TFUEL", 48, 14, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_1 > 0 and macd3_1 < 0:
                    Envelopes2_1 = get_Envelopes("KRW-TFUEL")
                    current_price_1 = get_current_price("KRW-TFUEL")
                    time.sleep(0.2)
                    if Envelopes2_1 > current_price_1:
                        price_1 = pyupbit.get_current_price("KRW-TFUEL")
                        time.sleep(0.2)
                        ...
                        current_price_1 = get_current_price("KRW-TFUEL")
                        time.sleep(0.2)
                        macd2_1 = get_macd("KRW-TFUEL", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_1 = get_Envelopes("KRW-TFUEL") * 0.98
                        time.sleep(0.2)
                        # print("검색 1 완료")
                        ma20_1 = get_ma20("KRW-TFUEL")
                        ma60_1 = get_ma60("KRW-TFUEL")
                        ma120_1 = get_ma120("KRW-TFUEL")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_1 < 0.00001:
                            if macd1_1 > 0 and macd3_1 < 0 and current_price_1 < Envelopes1_1:
                                ...
                                ret1 = upbit.buy_limit_order("KRW-TFUEL", current_price_1, (krw * 0.9995) / current_price_1)
                                uuid1 = ret1['uuid']
...
# 매도
    try:
        won1 = pyupbit.get_current_price("KRW-TFUEL")
        get2_1 = upbit.get_balance(ticker="KRW-TFUEL")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_1 > 1 and get2_1 > 0.00001:
            if won1 > (price1_1 * 1.007):
                ret1_1 = upbit.sell_limit_order("KRW-TFUEL", won1, get2_1)
                uuid1_1 = ret1_1['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_1 > 1 and get2_1 > 0.00001:
            if won1 < (price1_1 * 0.99):
                upbit.sell_market_order("KRW-TFUEL", get2_1)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_2 = upbit.get_balance(ticker="KRW-XRP")
        if krw > 5000 and get1_2 < 0.00001:
            data_2 = pyupbit.get_ohlcv(ticker="KRW-XRP", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_2 * 2.0) < curVolume_2:
                macd1_2 = get_macd("KRW-XRP", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_2 = get_macd("KRW-XRP", 48, 24, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_2 > 0 and macd3_2 < 0:
                    Envelopes2_2 = get_Envelopes("KRW-XRP")
                    current_price_2 = get_current_price("KRW-XRP")
                    time.sleep(0.2)
                    if Envelopes2_2 > current_price_2:
                        price_2 = pyupbit.get_current_price("KRW-XRP")
                        time.sleep(0.2)
                        ...
                        current_price_2 = get_current_price("KRW-XRP")
                        time.sleep(0.2)
                        macd2_2 = get_macd("KRW-XRP", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_2 = get_Envelopes("KRW-XRP") * 0.98
                        time.sleep(0.2)
                        # print("검색 2 완료")
                        ma20_2 = get_ma20("KRW-XRP")
                        ma60_2 = get_ma60("KRW-XRP")
                        ma120_2 = get_ma120("KRW-XRP")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_2 < 0.00001:
                            if macd1_2 > 0 and macd3_2 < 0 and current_price_2 < Envelopes1_2:
                                ...
                                ret2 = upbit.buy_limit_order("KRW-XRP", current_price_2, (krw * 0.9995) / current_price_2)
                                uuid2 = ret2['uuid']
...
# 매도
    try:
        won2 = pyupbit.get_current_price("KRW-XRP")
        get2_2 = upbit.get_balance(ticker="KRW-XRP")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_2 > 1 and get2_2 > 0.00001:
            if won2 > (price1_2 * 1.007):
                ret2_2 = upbit.sell_limit_order("KRW-XRP", won2, get2_2)
                uuid2_2 = ret2_2['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_2 > 1 and get2_2 > 0.00001:
            if won2 < (price1_2 * 0.99):
                upbit.sell_market_order("KRW-XRP", get2_2)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_3 = upbit.get_balance(ticker="KRW-CHZ")
        if krw > 5000 and get1_3 < 0.00001:
            data_3 = pyupbit.get_ohlcv(ticker="KRW-CHZ", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_3 * 2.0) < curVolume_3:
                macd1_3 = get_macd("KRW-CHZ", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_3 = get_macd("KRW-CHZ", 48, 34, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_3 > 0 and macd3_3 < 0:
                    Envelopes2_3 = get_Envelopes("KRW-CHZ")
                    current_price_3 = get_current_price("KRW-CHZ")
                    time.sleep(0.2)
                    if Envelopes2_3 > current_price_3:
                        price_3 = pyupbit.get_current_price("KRW-CHZ")
                        time.sleep(0.2)
                        ...
                        current_price_3 = get_current_price("KRW-CHZ")
                        time.sleep(0.2)
                        macd2_3 = get_macd("KRW-CHZ", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_3 = get_Envelopes("KRW-CHZ") * 0.98
                        time.sleep(0.2)
                        # print("검색 3 완료")
                        ma20_3 = get_ma20("KRW-CHZ")
                        ma60_3 = get_ma60("KRW-CHZ")
                        ma120_3 = get_ma120("KRW-CHZ")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_3 < 0.00001:
                            if macd1_3 > 0 and macd3_3 < 0 and current_price_3 < Envelopes1_3:
                                ...
                                ret3 = upbit.buy_limit_order("KRW-CHZ", current_price_3, (krw * 0.9995) / current_price_3)
                                uuid3 = ret3['uuid']
...
# 매도
    try:
        won3 = pyupbit.get_current_price("KRW-CHZ")
        get2_3 = upbit.get_balance(ticker="KRW-CHZ")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_3 > 1 and get2_3 > 0.00001:
            if won3 > (price1_3 * 1.007):
                ret3_3 = upbit.sell_limit_order("KRW-CHZ", won3, get2_3)
                uuid3_3 = ret3_3['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_3 > 1 and get2_3 > 0.00001:
            if won3 < (price1_3 * 0.99):
                upbit.sell_market_order("KRW-CHZ", get2_3)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_4 = upbit.get_balance(ticker="KRW-ETC")
        if krw > 5000 and get1_4 < 0.00001:
            data_4 = pyupbit.get_ohlcv(ticker="KRW-ETC", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_4 * 2.0) < curVolume_4:
                macd1_4 = get_macd("KRW-ETC", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_4 = get_macd("KRW-ETC", 48, 44, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_4 > 0 and macd3_4 < 0:
                    Envelopes2_4 = get_Envelopes("KRW-ETC")
                    current_price_4 = get_current_price("KRW-ETC")
                    time.sleep(0.2)
                    if Envelopes2_4 > current_price_4:
                        price_4 = pyupbit.get_current_price("KRW-ETC")
                        time.sleep(0.2)
                        ...
                        current_price_4 = get_current_price("KRW-ETC")
                        time.sleep(0.2)
                        macd2_4 = get_macd("KRW-ETC", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_4 = get_Envelopes("KRW-ETC") * 0.98
                        time.sleep(0.2)
                        # print("검색 4 완료")
                        ma20_4 = get_ma20("KRW-ETC")
                        ma60_4 = get_ma60("KRW-ETC")
                        ma120_4 = get_ma120("KRW-ETC")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_4 < 0.00001:
                            if macd1_4 > 0 and macd3_4 < 0 and current_price_4 < Envelopes1_4:
                                ...
                                ret4 = upbit.buy_limit_order("KRW-ETC", current_price_4, (krw * 0.9995) / current_price_4)
                                uuid4 = ret4['uuid']
...
# 매도
    try:
        won4 = pyupbit.get_current_price("KRW-ETC")
        get2_4 = upbit.get_balance(ticker="KRW-ETC")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_4 > 1 and get2_4 > 0.00001:
            if won4 > (price1_4 * 1.007):
                ret4_4 = upbit.sell_limit_order("KRW-ETC", won4, get2_4)
                uuid4_4 = ret4_4['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_4 > 1 and get2_4 > 0.00001:
            if won4 < (price1_4 * 0.99):
                upbit.sell_market_order("KRW-ETC", get2_4)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_5 = upbit.get_balance(ticker="KRW-AERGO")
        if krw > 5000 and get1_5 < 0.00001:
            data_5 = pyupbit.get_ohlcv(ticker="KRW-AERGO", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_5 * 2.0) < curVolume_5:
                macd1_5 = get_macd("KRW-AERGO", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_5 = get_macd("KRW-AERGO", 48, 54, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_5 > 0 and macd3_5 < 0:
                    Envelopes2_5 = get_Envelopes("KRW-AERGO")
                    current_price_5 = get_current_price("KRW-AERGO")
                    time.sleep(0.2)
                    if Envelopes2_5 > current_price_5:
                        price_5 = pyupbit.get_current_price("KRW-AERGO")
                        time.sleep(0.2)
                        ...
                        current_price_5 = get_current_price("KRW-AERGO")
                        time.sleep(0.2)
                        macd2_5 = get_macd("KRW-AERGO", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_5 = get_Envelopes("KRW-AERGO") * 0.98
                        time.sleep(0.2)
                        # print("검색 5 완료")
                        ma20_5 = get_ma20("KRW-AERGO")
                        ma60_5 = get_ma60("KRW-AERGO")
                        ma120_5 = get_ma120("KRW-AERGO")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_5 < 0.00001:
                            if macd1_5 > 0 and macd3_5 < 0 and current_price_5 < Envelopes1_5:
                                ...
                                ret5 = upbit.buy_limit_order("KRW-AERGO", current_price_5, (krw * 0.9995) / current_price_5)
                                uuid5 = ret5['uuid']
...
# 매도
    try:
        won5 = pyupbit.get_current_price("KRW-AERGO")
        get2_5 = upbit.get_balance(ticker="KRW-AERGO")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_5 > 1 and get2_5 > 0.00001:
            if won5 > (price1_5 * 1.007):
                ret5_5 = upbit.sell_limit_order("KRW-AERGO", won5, get2_5)
                uuid5_5 = ret5_5['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_5 > 1 and get2_5 > 0.00001:
            if won5 < (price1_5 * 0.99):
                upbit.sell_market_order("KRW-AERGO", get2_5)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_6 = upbit.get_balance(ticker="KRW-AHT")
        if krw > 5000 and get1_6 < 0.00001:
            data_6 = pyupbit.get_ohlcv(ticker="KRW-AHT", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_6 * 2.0) < curVolume_6:
                macd1_6 = get_macd("KRW-AHT", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_6 = get_macd("KRW-AHT", 48, 64, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_6 > 0 and macd3_6 < 0:
                    Envelopes2_6 = get_Envelopes("KRW-AHT")
                    current_price_6 = get_current_price("KRW-AHT")
                    time.sleep(0.2)
                    if Envelopes2_6 > current_price_6:
                        price_6 = pyupbit.get_current_price("KRW-AHT")
                        time.sleep(0.2)
                        ...
                        current_price_6 = get_current_price("KRW-AHT")
                        time.sleep(0.2)
                        macd2_6 = get_macd("KRW-AHT", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_6 = get_Envelopes("KRW-AHT") * 0.98
                        time.sleep(0.2)
                        # print("검색 6 완료")
                        ma20_6 = get_ma20("KRW-AHT")
                        ma60_6 = get_ma60("KRW-AHT")
                        ma120_6 = get_ma120("KRW-AHT")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_6 < 0.00001:
                            if macd1_6 > 0 and macd3_6 < 0 and current_price_6 < Envelopes1_6:
                                ...
                                ret6 = upbit.buy_limit_order("KRW-AHT", current_price_6, (krw * 0.9995) / current_price_6)
                                uuid6 = ret6['uuid']
...
# 매도
    try:
        won6 = pyupbit.get_current_price("KRW-AHT")
        get2_6 = upbit.get_balance(ticker="KRW-AHT")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_6 > 1 and get2_6 > 0.00001:
            if won6 > (price1_6 * 1.007):
                ret6_6 = upbit.sell_limit_order("KRW-AHT", won6, get2_6)
                uuid6_6 = ret6_6['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_6 > 1 and get2_6 > 0.00001:
            if won6 < (price1_6 * 0.99):
                upbit.sell_market_order("KRW-AHT", get2_6)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_7 = upbit.get_balance(ticker="KRW-ADA")
        if krw > 5000 and get1_7 < 0.00001:
            data_7 = pyupbit.get_ohlcv(ticker="KRW-ADA", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_7 * 2.0) < curVolume_7:
                macd1_7 = get_macd("KRW-ADA", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_7 = get_macd("KRW-ADA", 48, 74, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_7 > 0 and macd3_7 < 0:
                    Envelopes2_7 = get_Envelopes("KRW-ADA")
                    current_price_7 = get_current_price("KRW-ADA")
                    time.sleep(0.2)
                    if Envelopes2_7 > current_price_7:
                        price_7 = pyupbit.get_current_price("KRW-ADA")
                        time.sleep(0.2)
                        ...
                        current_price_7 = get_current_price("KRW-ADA")
                        time.sleep(0.2)
                        macd2_7 = get_macd("KRW-ADA", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_7 = get_Envelopes("KRW-ADA") * 0.98
                        time.sleep(0.2)
                        # print("검색 7 완료")
                        ma20_7 = get_ma20("KRW-ADA")
                        ma60_7 = get_ma60("KRW-ADA")
                        ma120_7 = get_ma120("KRW-ADA")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_7 < 0.00001:
                            if macd1_7 > 0 and macd3_7 < 0 and current_price_7 < Envelopes1_7:
                                ...
                                ret7 = upbit.buy_limit_order("KRW-ADA", current_price_7, (krw * 0.9995) / current_price_7)
                                uuid7 = ret7['uuid']
...
# 매도
    try:
        won7 = pyupbit.get_current_price("KRW-ADA")
        get2_7 = upbit.get_balance(ticker="KRW-ADA")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_7 > 1 and get2_7 > 0.00001:
            if won7 > (price1_7 * 1.007):
                ret7_7 = upbit.sell_limit_order("KRW-ADA", won7, get2_7)
                uuid7_7 = ret7_7['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_7 > 1 and get2_7 > 0.00001:
            if won7 < (price1_7 * 0.99):
                upbit.sell_market_order("KRW-ADA", get2_7)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_8 = upbit.get_balance(ticker="KRW-WAVES")
        if krw > 5000 and get1_8 < 0.00001:
            data_8 = pyupbit.get_ohlcv(ticker="KRW-WAVES", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_8 * 2.0) < curVolume_8:
                macd1_8 = get_macd("KRW-WAVES", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_8 = get_macd("KRW-WAVES", 48, 84, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_8 > 0 and macd3_8 < 0:
                    Envelopes2_8 = get_Envelopes("KRW-WAVES")
                    current_price_8 = get_current_price("KRW-WAVES")
                    time.sleep(0.2)
                    if Envelopes2_8 > current_price_8:
                        price_8 = pyupbit.get_current_price("KRW-WAVES")
                        time.sleep(0.2)
                        ...
                        current_price_8 = get_current_price("KRW-WAVES")
                        time.sleep(0.2)
                        macd2_8 = get_macd("KRW-WAVES", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_8 = get_Envelopes("KRW-WAVES") * 0.98
                        time.sleep(0.2)
                        # print("검색 8 완료")
                        ma20_8 = get_ma20("KRW-WAVES")
                        ma60_8 = get_ma60("KRW-WAVES")
                        ma120_8 = get_ma120("KRW-WAVES")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_8 < 0.00001:
                            if macd1_8 > 0 and macd3_8 < 0 and current_price_8 < Envelopes1_8:
                                ...
                                ret8 = upbit.buy_limit_order("KRW-WAVES", current_price_8, (krw * 0.9995) / current_price_8)
                                uuid8 = ret8['uuid']
...
# 매도
    try:
        won8 = pyupbit.get_current_price("KRW-WAVES")
        get2_8 = upbit.get_balance(ticker="KRW-WAVES")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_8 > 1 and get2_8 > 0.00001:
            if won8 > (price1_8 * 1.007):
                ret8_8 = upbit.sell_limit_order("KRW-WAVES", won8, get2_8)
                uuid8_8 = ret8_8['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_8 > 1 and get2_8 > 0.00001:
            if won8 < (price1_8 * 0.99):
                upbit.sell_market_order("KRW-WAVES", get2_8)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_9 = upbit.get_balance(ticker="KRW-THETA")
        if krw > 5000 and get1_9 < 0.00001:
            data_9 = pyupbit.get_ohlcv(ticker="KRW-THETA", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_9 * 2.0) < curVolume_9:
                macd1_9 = get_macd("KRW-THETA", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_9 = get_macd("KRW-THETA", 48, 94, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_9 > 0 and macd3_9 < 0:
                    Envelopes2_9 = get_Envelopes("KRW-THETA")
                    current_price_9 = get_current_price("KRW-THETA")
                    time.sleep(0.2)
                    if Envelopes2_9 > current_price_9:
                        price_9 = pyupbit.get_current_price("KRW-THETA")
                        time.sleep(0.2)
                        ...
                        current_price_9 = get_current_price("KRW-THETA")
                        time.sleep(0.2)
                        macd2_9 = get_macd("KRW-THETA", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_9 = get_Envelopes("KRW-THETA") * 0.98
                        time.sleep(0.2)
                        # print("검색 9 완료")
                        ma20_9 = get_ma20("KRW-THETA")
                        ma60_9 = get_ma60("KRW-THETA")
                        ma120_9 = get_ma120("KRW-THETA")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_9 < 0.00001:
                            if macd1_9 > 0 and macd3_9 < 0 and current_price_9 < Envelopes1_9:
                                ...
                                ret9 = upbit.buy_limit_order("KRW-THETA", current_price_9, (krw * 0.9995) / current_price_9)
                                uuid9 = ret9['uuid']
...
# 매도
    try:
        won9 = pyupbit.get_current_price("KRW-THETA")
        get2_9 = upbit.get_balance(ticker="KRW-THETA")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_9 > 1 and get2_9 > 0.00001:
            if won9 > (price1_9 * 1.007):
                ret9_9 = upbit.sell_limit_order("KRW-THETA", won9, get2_9)
                uuid9_9 = ret9_9['uuid']
    except: 
        pass
    try:
    ...
    try:
        if price1_9 > 1 and get2_9 > 0.00001:
            if won9 < (price1_9 * 0.99):
                upbit.sell_market_order("KRW-THETA", get2_9)
...
#############################################################################################################
    try:
        krw = get_balance("KRW")
        get1_10 = upbit.get_balance(ticker="KRW-EOS")
        if krw > 5000 and get1_10 < 0.00001:
            data_10 = pyupbit.get_ohlcv(ticker="KRW-EOS", interval="minute1")#(최대 200개까지 요청가능)
            ...
            if (firstVolume_10 * 2.0) < curVolume_10:
                macd1_10 = get_macd("KRW-EOS", 12, 26, 9).iloc[-1]
                time.sleep(0.2)
                macd3_10 = get_macd("KRW-EOS", 48, 104, 9).iloc[-1]
                time.sleep(0.2)
                if macd1_10 > 0 and macd3_10 < 0:
                    Envelopes2_10 = get_Envelopes("KRW-EOS")
                    current_price_10 = get_current_price("KRW-EOS")
                    time.sleep(0.2)
                    if Envelopes2_10 > current_price_10:
                        price_10 = pyupbit.get_current_price("KRW-EOS")
                        time.sleep(0.2)
                        ...
                        current_price_10 = get_current_price("KRW-EOS")
                        time.sleep(0.2)
                        macd2_10 = get_macd("KRW-EOS", 24, 52, 9).iloc[-1]
                        time.sleep(0.2)
                        Envelopes1_10 = get_Envelopes("KRW-EOS") * 0.98
                        time.sleep(0.2)
                        # print("검색 10 완료")
                        ma20_10 = get_ma20("KRW-EOS")
                        ma60_10 = get_ma60("KRW-EOS")
                        ma120_10 = get_ma120("KRW-EOS")
                        time.sleep(0.2)
...
# 매수
                        if krw > 5000 and get1_10 < 0.00001:
                            if macd1_10 > 0 and macd3_10 < 0 and current_price_10 < Envelopes1_10:
                                ...
                                ret10 = upbit.buy_limit_order("KRW-EOS", current_price_10, (krw * 0.9995) / current_price_10)
                                uuid10 = ret10['uuid']
...
# 매도
    try:
        won10 = pyupbit.get_current_price("KRW-EOS")
        get2_10 = upbit.get_balance(ticker="KRW-EOS")       
        time.sleep(0.2)
    except:
        pass
    try:
        if price1_10 > 1 and get2_10 > 0.00001:
            if won10 > (price1_10 * 1.007):
                ret10_10 = upbit.sell_limit_order("KRW-EOS", won10, get2_10)
    ...
    try:
        if price1_10 > 1 and get2_10 > 0.00001:
            if won10 < (price1_10 * 0.99):
                upbit.sell_market_order("KRW-EOS", get2_10)
